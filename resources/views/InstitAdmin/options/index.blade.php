    ...
    <!-- Content Row -->
        <div class="card">
            <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{route('create.option')}}" class="btn btn-primary">
                            ...
                            <tr data-entry-id="{{ $option->id }}">
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{route('edit.option' ,$option->id)}}" class="btn btn-info">
                                            <i class="fa fa-pencil-alt"></i>
                                        </a>
                                        <form onclick="return confirm('are you sure ? ')" class="d-inline" action="{{ route('delete.option' ,  $option->id) }}" method="POST">
                                        @method('Delete')
                          @csrf
                          {{ method_field('Delete') }}
