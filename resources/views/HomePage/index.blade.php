...
<head>
  ...
  <!--
      ...
      =============================================
    -->
  <link rel="stylesheet" href="{{ asset('HomePageFrontend/css/linearicons.css') }}" />
  <link rel="stylesheet" href="{{ asset('HomePageFrontend/css/font-awesome.min.css') }}" />
  <link rel="stylesheet" href="{{ asset('HomePageFrontend/css/bootstrap.css') }}" />
  <link rel="stylesheet" href="{{ asset('HomePageFrontend/css/magnific-popup.css') }}" />
  <link rel="stylesheet" href="{{ asset('HomePageFrontend/css/owl.carousel.css') }}" />
  <link rel="stylesheet" href="{{ asset('HomePageFrontend/css/nice-select.css') }}">
  <link rel="stylesheet" href="{{ asset('HomePageFrontend/css/hexagons.min.css') }}" />
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/themify-icons/0.1.2/css/themify-icons.css" />
  <link rel="stylesheet" href="{{ asset('HomePageFrontend/css/main.css') }}" />
    ...
    <nav class="navbar navbar-expand-lg  navbar-light">
      <div class="container">
        <a class="navbar-brand" href="{{ route('homepage') }}">
          <img src="{{ asset('HomePageFrontend/img/QaderLogo.png') }}" alt="" height="80" width="200"/>
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarSupportedContent">
          <ul class="navbar-nav">
            ...
            <li><a href="{{ route('login') }}">Company Admin Sign in</a></li>
            <li><a href="{{ route('register') }}">Company Admin Sign up</a></li>
              <li><a href="{{ route('Institlogin') }}">Instit Sign in</a></li>
              <li><a href="{{ route('Institregister') }}">Instit Sign up</a></li>
              <li><a href="{{ route('Employeelogin') }}">Employee Sign in</a></li>
              <li><a href="{{ route('Employeeregister') }}">Employee Sign up</a></li>
    ...
    <div class="container">
      <div class="row justify-content-center fullscreen align-items-center">
        <div class="col-lg-5 col-md-8 home-banner-left">
          <h1 class="text-white">
            Increase your employees skils with us <br />

          </h1>

        </div>
        <div class="offset-lg-2 col-lg-5 col-md-12 home-banner-right">
          <img class="img-fluid" src="{{ asset('HomePageFrontend/img/header-img.png') }}" alt="" />
        </div>
      </div>HomePageFrontend/img/header-img.png
    </div>
  </section>
  <!-- ================ End banner Area ================= -->
      ...
      <div class="feature-inner row">
        ...
        <div class="col-lg-2 col-md-6">
          <div class="feature-item d-flex">
            <i class="ti-cup"></i>
            <div class="ml-20">
              <h4>Track your employees achievements</h4>
              <p>
                <!--اهبد فيها بعدين-->
              </p>
            </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <a href="{{ route('homepage') }}" target="_blank">Qader</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
  ...
  <script src="{{ asset('HomePageFrontend/js/vendor/jquery-2.2.4.min.js') }}"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4"
    crossorigin="anonymous"></script>
  <script src="{{ asset('HomePageFrontend/js/vendor/bootstrap.min.js') }}"></script>
  <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
  <script src="{{ asset('HomePageFrontend/js/jquery.ajaxchimp.min.js') }}"></script>
  <script src="{{ asset('HomePageFrontend/js/jquery.magnific-popup.min.js') }}"></script>
  <script src="{{ asset('HomePageFrontend/js/parallax.min.js') }}"></script>
  <script src="{{ asset('HomePageFrontend/js/owl.carousel.min.js') }}"></script>
  <script src="{{ asset('HomePageFrontend/js/jquery.sticky.js') }}"></script>
  <script src="{{ asset('HomePageFrontend/js/hexagons.min.js') }}"></script>
  <script src="{{ asset('HomePageFrontend/js/jquery.counterup.min.js') }}"></script>
  <script src="{{ asset('HomePageFrontend/js/waypoints.min.js') }}"></script>
  <script src="{{ asset('HomePageFrontend/js/jquery.nice-select.min.js') }}"></script>
  <script src="{{ asset('HomePageFrontend/js/main.js') }}"></script>
</body>
